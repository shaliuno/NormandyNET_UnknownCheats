    ...
    public partial class IconColors : MetroForm
    {
        ...
        private void metroListViewEntityTypeColors_DoubleClick(object sender, EventArgs e)
        {
            if (metroListViewEntityTypeColors.SelectedItems.Count == 1)
            {
                ...
                var haveEntityTypeColor = ModuleRUST.settingsForm.settingsJson.Colors.EntityColors.EntityTypeColors.TryGetValue(entityType, out Color entityColor);
                ...
                if (colorDlg.ShowDialog() == DialogResult.OK)
                {
                    if (haveEntityTypeColor)
                    {
                        ModuleRUST.settingsForm.settingsJson.Colors.EntityColors.EntityTypeColors[entityType] = colorDlg.Color;
                    }
        ...
        private void metroListViewEntityTypeColors_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
        {
            ...
            switch (e.ColumnIndex)
            {
                ...
                case 1:
                    ...
                    if (ModuleRUST.settingsForm.settingsJson.Colors.EntityColors.EntityTypeColors.TryGetValue(e.Item.Text, out Color entityColor))
                    {
        ...
        private void IconColors_Load(object sender, EventArgs e)
        {
            ...
            foreach (string entityType in LootItemHelper.EntityTypesCanShow)
            {
                ...
                {
                    if (ModuleRUST.settingsForm.settingsJson.Colors.EntityColors.EntityTypeColors.TryGetValue(entityType, out color))
                    {
                    ...
                    else
                    {
                        ...
                        ModuleRUST.settingsForm.settingsJson.Colors.EntityColors.EntityTypeColors.Add(entityType, Color.Gray);
                    }
                }
            }

            if (ModuleRUST.settingsForm.settingsJson.Colors.EntityColors.EntityTypeColors.TryGetValue("Unknown", out color))
            {
            ...
            else
            {
                ...
                ModuleRUST.settingsForm.settingsJson.Colors.EntityColors.EntityTypeColors.Add("Unknown", Color.Gray);
            }
