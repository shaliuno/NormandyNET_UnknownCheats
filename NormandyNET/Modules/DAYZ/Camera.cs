...
namespace NormandyNET.Modules.DAYZ
{
    internal class Camera
    {
        ...
        internal static Vector3 WorldToScreen(Vector3 position)
        {
            ...
            return new Vector3(
               ((ModuleDAYZ.radarForm.overlay.Width / 2) * (1 + (x / ProjectionD1.X / z))) - (ModuleDAYZ.radarForm.overlay.Width / 2),
               ((ModuleDAYZ.radarForm.overlay.Height / 2) * (1 - (y / ProjectionD2.Y / z))) - (ModuleDAYZ.radarForm.overlay.Height / 2),
               z);
        }
        ...
        internal static Vector3 GetViewRight()
        {
            ...
            return Memory.Read<Vector3>(camera + ModuleDAYZ.offsetsDAYZ.Camera_ViewRight);
        }
        ...
        internal static Vector3 GetViewUp()
        {
            ...
            return Memory.Read<Vector3>(camera + ModuleDAYZ.offsetsDAYZ.Camera_ViewUp);
        }
        ...
        internal static Vector3 GetViewForward()
        {
            ...
            return Memory.Read<Vector3>(camera + ModuleDAYZ.offsetsDAYZ.Camera_ViewForward);
        }
        ...
        internal static Vector3 GetViewTranslation()
        {
            ...
            return Memory.Read<Vector3>(camera + ModuleDAYZ.offsetsDAYZ.Camera_ViewTranslation);
        }
        ...
        internal static Vector3 GetViewportSize()
        {
            ...
            return Memory.Read<Vector3>(camera + ModuleDAYZ.offsetsDAYZ.Camera_ViewportSize);
        }
        ...
        internal static Vector3 GetProjectionD1()
        {
            ...
            return Memory.Read<Vector3>(camera + ModuleDAYZ.offsetsDAYZ.Camera_Projection_D1);
        }
        ...
        internal static Vector3 GetProjectionD2()
        {
            ...
            return Memory.Read<Vector3>(camera + ModuleDAYZ.offsetsDAYZ.Camera_Projection_D2);
        }
    }
}