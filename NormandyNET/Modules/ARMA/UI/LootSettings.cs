...
namespace NormandyNET.Modules.ARMA.UI
{
    public partial class LootSettings : MetroForm
    {
        public LootSettings()
        {
            ...
            metroCheckBoxLootLive.Checked = ModuleARMA.settingsForm.settingsJson.Loot.LiveLoot;
            metroTrackBarLootLiveAmountPerCycle.Value = ModuleARMA.settingsForm.settingsJson.Loot.LiveLootPerCycle;
        ...
        private void metroListViewLootCategoryColors_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (listViewLootCategoryColorsSender.SelectedItems.Count == 1)
            {
                ...
                {
                    if (ModuleARMA.settingsForm.settingsJson.Colors.LootColors.LootCategoryColors.TryGetValue(entityType, out Color entityColor))
                    {
                        ModuleARMA.settingsForm.settingsJson.Colors.LootColors.LootCategoryColors[entityType] = colorDlg.Color;
                    }
        ...
        private void metroListViewLootCategoryColors_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
        {
            ...
            switch (e.ColumnIndex)
            {
                ...
                case 1:
                    ...
                    if (ModuleARMA.settingsForm.settingsJson.Colors.LootColors.LootCategoryColors.TryGetValue(e.Item.Text, out Color entityColor))
                    {
        ...
        private void LootColors_Load(object sender, EventArgs e)
        {
            ...
            {
                if (ModuleARMA.settingsForm.settingsJson.Colors.LootColors.LootCategoryColors.TryGetValue(entityType, out color))
                {
                ...
                else
                {
                    ...
                    ModuleARMA.settingsForm.settingsJson.Colors.LootColors.LootCategoryColors.Add(entityType, Color.Gray);
                }

                limit++;
            }
            this.Height = Math.Max(Math.Max(metroListViewLootCategoryColors.Items.Count, metroListViewLootCategoryColors2.Items.Count) * 20, 554);
        }
        ...
        private void metroTrackBarLootLiveAmountPerCycle_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            ModuleARMA.settingsForm.settingsJson.Loot.LiveLootPerCycle = metroTrackBarLootLiveAmountPerCycle.Value;
        ...
        {
            ModuleARMA.settingsForm.settingsJson.Loot.LiveLoot = metroCheckBoxLootLive.Checked;
        }
    }
}