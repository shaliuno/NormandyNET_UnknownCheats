    ...
    public class SettingsARMAJson
    {
        ...
        public class ColorSetting
        {
            ...
            public class EntityColorSetting
            {
                ...
                public Dictionary<string, Color> EntityTypeColors = new Dictionary<string, Color>
                  {
                      ...
                      { "Soldier" , ColorTranslator.FromHtml("DodgerBlue") },
                      { "SoldierNPC" , ColorTranslator.FromHtml("DodgerBlue") },
                      { "You" , ColorTranslator.FromHtml("#80FF00") },

                      { "Vehicle" , ColorTranslator.FromHtml("#b00000") },
                      { "Vehicle - Ammotruck" , Color.FromArgb(255, 0, 255) },
                      { "Vehicle - Supplytruck" , Color.FromArgb(153, 51, 255) },
                      { "Vehicle - Support" , Color.FromArgb(153, 51, 255) },
                      { "Vehicle - Military" , Color.FromArgb(0, 204, 0) },
                      { "Vehicle - Armored" , Color.FromArgb(0, 128, 255) },
                      { "Vehicle - Civilian" , Color.FromArgb(176, 0, 0) },
                      { "Vehicle - BikeMoto" , Color.FromArgb(144, 0, 0) },
                      { "Vehicle - Aircraft" , Color.FromArgb(255, 0, 0) },
                      { "Vehicle - Watercraft" , Color.FromArgb(51, 51, 255) },
                      { "Stationary" , Color.FromArgb(255, 0, 160) },

                      { "Tent" , Color.FromArgb(0, 255, 128) },
                      { "Crate - Ammo" , Color.FromArgb(255, 160, 0) },
                      { "Crate - Common" , Color.FromArgb(255, 160, 0) },
                      { "Crate - Military" , Color.FromArgb(255, 160, 0) },
                ...
                public Dictionary<string, Color> OtherColors = new Dictionary<string, Color>
                  {
                      { "Friend" , Color.FromArgb(0, 255, 255) },
                      { "Admin" , Color.FromArgb(255, 0, 0) },
                      { "Invisible" , ColorTranslator.FromHtml("Gray") },

                      { "Side - BLUEFOR" , Color.FromArgb(0, 96, 255) },
                      { "Side - OPFOR" , ColorTranslator.FromHtml("Red")  },
                      { "Side - INDI" , ColorTranslator.FromHtml("LawnGreen")  },
                      { "Side - CIV" , ColorTranslator.FromHtml("DarkGray")  },
                  };
            }
        ...
        public class EntitySetting
        {
            ...
            public bool VehiclePassengers = true;
            public bool VehiclePassengersDetailed = true;
